...
class KurtasView extends StatelessWidget {
  const KurtasView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Kurtas'),
      ),
      body: ListView(
        children: [
          _buildItem('Dark Blue Kurta', 650, 3250, 80),
          _buildItem('Green Kurta', 800, 2000, 60),
        ],
      ),
    );
  }
